...
<a href="https://Criptify" style="color:#000"><h3 align="center">Criptify</h3></a>

<div align="center">

[![Status](https://img.shields.io/badge/status-active-success.svg)](#)
[![License: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](#)
[![CodeQL](https://github.com/sh-dv/Criptify/actions/workflows/codeql-analysis.yml/badge.svg)](https://github.com/sh-dv/Criptify/actions/workflows/codeql-analysis.yml)
[![Node.js CI](https://github.com/sh-dv/Criptify/actions/workflows/node.js.yml/badge.svg?branch=master)](https://github.com/sh-dv/Criptify/actions/workflows/node.js.yml)
[![Snyk](https://github.com/sh-dv/Criptify/actions/workflows/snyk.yml/badge.svg)](https://github.com/sh-dv/Criptify/actions/workflows/snyk.yml)

</div>

---

[Criptify](https://Criptify) is a web app that provides secure local file encryption in the browser. It's fast, secure, and uses modern cryptographic algorithms with chunked AEAD stream encryption/decryption.

V2 of Criptify introduced memory efficient in-browser large file chunked encryption using streams with libsodium.
...
The app can be easily self hosted, please follow the [installation](https://Criptify/about/#installation) instructions.
...
[Copyright (c) 2022 sh-dv](https://github.com/sh-dv/Criptify/blob/master/LICENSE)
