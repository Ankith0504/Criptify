const en_US = {
  ...
  // Menu
  sub_title: "Simplest, fast, secure client-side file encryption",
  home: "Home",
  about: "About",
  ...
  changelog: "Changelog",
  donation_message: "Love Criptify? You can donate to support the project.",
  ...
  multiple_tabs_alert_notice_one: "Looks like that Criptify is already open in another window/tab.",
  ...
  file_not_encrypted_corrupted: "This file was not encrypted using Criptify or the file may be corrupted!",
  old_version: "This file was encrypted using an older version of Criptify, you can decrypt this file by visiting the v1 app.",
