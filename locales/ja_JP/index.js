const ja_JP = {
  ...
  changelog: "変更履歴",
  donation_message: "Criptifyを気に入ってくれましたか? 寄付をすることでこのプロジェクトを支援できます。",
  ...
  multiple_tabs_alert_notice_one: "Criptifyをすでに他のウィンドウやタブで開いているようです。",
  ...
  file_not_encrypted_corrupted: "このファイルはCriptifyを使用して暗号化されていないか、ファイルが破損している可能性があります！",
  old_version: "このファイルは古いバージョンのCriptifyを使用して暗号化されています。v1アプリにアクセスして復号化することができます。",
