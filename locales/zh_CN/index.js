const zh_CN = {
    ...
    donation_message: "喜欢 Criptify 吗？您可以捐赠来支持本项目", // Love Criptify? You can donate to support the project.
    ...
    multiple_tabs_alert_notice_one: "Criptify 已经在另一标签窗口打开", // Looks like that Criptify is already open in another window/tab.
    ...
    file_not_encrypted_corrupted: "该文件不是使用 Criptify 加密的，或者文件已损坏！", // This file was not encrypted using Criptify or the file may be corrupted!
    old_version: "文件由老版本 Criptify 加密，访问 v1 版本来解密", // This file was encrypted using an older version of Criptify, you can decrypt this file by visiting the v1 app.
